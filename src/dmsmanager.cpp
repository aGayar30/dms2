...
DMSManager::DMSManager(ThreadSafeQueue<cv::Mat>& cameraQueue, ThreadSafeQueue<cv::Mat>& preprocessingQueue, ThreadSafeQueue<cv::Mat>& faceDetectionQueue, ThreadSafeQueue<cv::Mat>& drowsinessDetectionQueue,ThreadSafeQueue<std::string>& headposeDetectionQueue, ThreadSafeQueue<cv::Mat>& tcpOutputQueue, int tcpPort , ThreadSafeQueue<CarState>& stateOutputQueue , ThreadSafeQueue<int>& postOutputQueue,ThreadSafeQueue<std::string>& commandsQueue,ThreadSafeQueue<std::string>& faultsQueue)
...
headposeComponent(faceDetectionQueue, headposeDetectionQueue,commandsQueue,faultsQueue),
eyegazeComponent(faceDetectionQueue, eyegazeDetectionQueue,commandsQueue,faultsQueue),
...
eyegazeDetectionQueue(eyegazeDetectionQueue),
...
void DMSManager::eyegazeLoop() {
    headposeComponent.startEyeGazeDetection();
}
