...
int main() {
    ...
    DMSManager dmsManager(cameraQueue, preprocessingQueue, faceDetectionQueue, drowsinessDetectionQueue, headposeDetectionQueue,eyegazeDetectionQueue, tcpOutputQueue, tcpPort, stateOutputQueue, postOutputQueue,commandsQueue,faultsQueue);
